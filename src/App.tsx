...
const SchichtWochenplanPage = lazy(() => import('@/pages/intents/SchichtWochenplanPage'));
const SchichtBestaetigungPage = lazy(() => import('@/pages/intents/SchichtBestaetigungPage'));
      ...
      <ActionsProvider>
        <Routes>
          <Route element={<Layout />}>
            ...
            <Route path="intents/schicht-wochenplan" element={<Suspense fallback={null}><SchichtWochenplanPage /></Suspense>} />
            <Route path="intents/schicht-bestaetigung" element={<Suspense fallback={null}><SchichtBestaetigungPage /></Suspense>} />
          </Route>
        </Routes>
      </ActionsProvider>
    </HashRouter>
