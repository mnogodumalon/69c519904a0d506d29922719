...
export function SchichtplanungViewDialog({ open, onClose, record, onEdit, mitarbeiterList, schichtvorlagenList, standorte_abteilungenList }: SchichtplanungViewDialogProps) {
