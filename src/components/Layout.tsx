...
import { IconArrowBackUp, IconClock, IconLayoutDashboard, IconMapPin, IconMenu2, IconSettings, IconUsers } from '@tabler/icons-react';
...
const navigation = [
  ...
  { name: 'Standorte & Abteilungen', href: '/standorte-abteilungen', icon: IconMapPin },
  { name: 'Schichtvorlagen', href: '/schichtvorlagen', icon: IconClock },
  { name: 'Schichtplanung', href: '/schichtplanung', icon: IconClock },
];

const externalNavigation = [
  { name: 'Mitarbeiter', href: '/gateway/apps/69c519719a8c4a3e9d08485f?template=list_page', icon: IconUsers },
  { name: 'Standorte & Abteilungen', href: '/gateway/apps/69c5196c30a2e351ed55e8e6?template=list_page', icon: IconMapPin },
  { name: 'Schichtvorlagen', href: '/gateway/apps/69c51971ed063aab6dfc28d0?template=list_page', icon: IconClock },
  { name: 'Schichtplanung', href: '/gateway/apps/69c51972c9beadf114b98825?template=list_page', icon: IconClock },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69c519719a8c4a3e9d08485f?template=list_page"
